...
import com.example.item.custom.SphereDebugItem;
...
public class ModItems {
    ...
    public static final Item SPHERE_DEBUG = registerItem("sphere_debug", new SphereDebugItem(new FabricItemSettings()));
