...
public class ObjectivePingEntity extends Entity {
    ...
    public ObjectivePingEntity(World level, double x, double y, double z, int color, UUID uuid) {
        super(EntityTypeModule.OBJECTIVE_PING, level);
        setPosition(x, y, z);
        setColor(color);
    ...
    public boolean method_30632(BlockPos pos, BlockState state) {
        return false;
    }
